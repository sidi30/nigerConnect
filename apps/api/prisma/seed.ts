...
async function main(): Promise<void> {
  ...
  if (existingAssocs < 5) {
    const assocs = [
      { name: 'Nigériens de Paris', category: 'generaliste' as const, city: 'Paris', countryCode: 'FR' },
      { name: 'Étudiants Nigériens de Montréal', category: 'etudiants' as const, city: 'Montréal', countryCode: 'CA' },
      { name: 'Femmes Nigériennes en Diaspora', category: 'femmes' as const, city: 'Bruxelles', countryCode: 'BE' },
      { name: 'Jeunesse Niger Belgique', category: 'jeunesse' as const, city: 'Bruxelles', countryCode: 'BE' },
      { name: 'Business Club NE-US', category: 'business' as const, city: 'New York', countryCode: 'US' },
    ];
