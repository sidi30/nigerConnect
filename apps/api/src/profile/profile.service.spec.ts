...
/** Coffre d'archivage éteint par défaut : deleteAccount détruit comme avant. */
const makeArchiver = () => ({
  isEnabled: false,
  archiveDocument: jest.fn(async () => false),
  onAccountDeleted: jest.fn(async () => undefined),
});
