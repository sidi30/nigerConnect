...
<body style="margin:0;padding:0;background:${b.cream};">
  ...
  async sendEmailVerification(
    ...
    const bodyHtml = `
      ...
      ${this.codeBlock(code)}
      <p style="margin:18px 0 24px;text-align:center;font-size:13px;color:${b.tan500};">Code valable <strong>30 minutes</strong>.</p>
    ...
    const text =
      ...
      `Saisis-le dans l'application (valable 30 minutes).\n\n` +
