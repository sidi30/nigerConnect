...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: "Écris à privacy@nigerconnect.ne depuis l'adresse de ton compte. Tu reçois un export JSON complet sous 30 jours conformément au RGPD.",
  },
  {
    q: "Mon compte a été suspendu, que faire ?",
    a: "Écris à appeals@nigerconnect.ne en précisant l'email du compte. L'équipe modération répond sous 72 h ouvrées.",
  },
  {
    q: "Je n'ai pas reçu l'email de vérification",
    a: "Vérifie tes spams. Si toujours rien, demande un nouveau lien depuis l'app (Paramètres → Vérifier mon email) ou écris à support@nigerconnect.ne.",
  },
  {
    q: "Je veux signaler un contenu",
    a: "Touche le bouton ⋯ ou 🚩 sur la publication / le profil concerné depuis l'app. Pour une urgence (mineur en danger, menace physique), écris directement à safety@nigerconnect.ne.",
  },
  {
