...
| Contact email | `contact@nigerconnect.ne` |
...
Support : contact@nigerconnect.ne
```
...
Contact : contact@nigerconnect.ne
```
...
- [ ] Email `contact@nigerconnect.ne` reçoit (test : envoyer un mail bidon, vérifier réception)
...
| Email de contact public | ✅ `contact@nigerconnect.ne` (à activer côté boîte mail) |
